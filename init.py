...
mycursor.execute("CREATE TABLE `themes` (`Name` TEXT NOT NULL,`color1` TEXT NOT NULL,`color2` INT NOT NULL,`color3` TEXT NOT NULL,`color4` TEXT NOT NULL)")

mycursor.execute("INSERT INTO themes (Name, color1, color2, color3, color4) VALUES ('default', '#0d1821', '#f0f4ef', '#b4cded', '#05001e')")
