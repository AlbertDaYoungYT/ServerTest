...
def HomePage():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.homeTextPage[lang],
        ...
        return render_template(
            ...
            SiteData=Text.homeTextPage[lang],
            StaticData=Text.staticPageData,
            SiteWelcome=random.choice(Text.homeTextPage["en"]["SiteWelcome"]) % (data[1],),
            isloggedin=True,
            isadmin=False,
            Theme=Theme,
            Page="Home",
...
def About():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.aboutTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def Shop():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.shopTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def SignIn():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.signinTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def SignUp():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.signupTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def Help():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.helpTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def AskTheCreator():
    ...
    if Uid == None:
        ...
        return render_template(
            ...
            UserName="Test",
            UserProfile="Test",
            SiteData=Text.askTextPage[lang],
            StaticData=Text.staticPageData,
            isloggedin=False,
            isadmin=False,
            Theme=Theme,
...
def invalid_route(e):
    ...
    return render_template(
        ...
        UserName="Test",
        UserProfile="Test",
        SiteData=Text.errorTextPage[lang],
        StaticData=Text.staticPageData,
        isloggedin=False,
        isadmin=False,
        Theme=Theme,
